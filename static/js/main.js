...
function documentReadyInit() {
  ...
  jQuery('form.contact-form').on('submit', function(e) {
    ...
    jQuery($form)
      .find('span.contact-form-respond')
      .remove();
    ...
    $googleMaps.each(function() {
      ...
      var markerTitle = $map
        ...
        ? $map
            ...
            .text()
        : 'Map Title';
      var markerIconSrc = $map
        .find('.map_marker_icon')
        .first()
        .attr('src');
