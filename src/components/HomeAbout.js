      ...
      <div className="row">
        <div className="col-md-offset-1 col-md-10 col-lg-offset-0 col-lg-6">
          <div className="heading bottommargin_40">
            <p className="text-uppercase josefin grey fontsize_20">History</p>
            <h2 className="section_header topmargin_5 bottommargin_0">
              About our agency
            </h2>
          </div>
          <p>
            Aliquam eu enim tincidunt, auctor velit sit amet, auctor sapien.
            Aenean iaculis posuere dolor in vulputate. Nunc fermentum lobortis
            odio. Ut libero magna, aliquam in eget, iaculis sit amet neque. Sed
            eget viverra metus, nec facilisis quam. Nunc id ex erat. Aliquam
            congue purus libero, nec gravida nisi rutrum iaculis.
          </p>
          <ul className="list2 leftmargin_50 topmargin_30">
            ...
            <li>
              Aliquam non nulla volutpat, venenatis enim et, venenatis est.;
            </li>
            <li>
              Mauris consequat, neque ac pharetra mattis, orci diam malesuada
              purus;
            </li>
